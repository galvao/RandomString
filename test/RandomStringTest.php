...
class RandomStringTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $r = new RandomString\RandomString(12, array('upperCase'));
    ...
    {
        $r = new RandomString\RandomString(12, array('lowerCase'));
        $this->assertRegExp('/^[a-z]+$/', $r->result);
    }

    public function testLettersOnly()
    {
        $r = new RandomString\RandomString(12, array('upperCase', 'lowerCase'));
        $this->assertRegExp('/^[A-Z]+$/i', $r->result);
    }

    public function testNumbersOnly()
    {
        $r = new RandomString\RandomString(12, array('numbers'));
